...
[Русская версия](README.md) · [Architecture](docs/ARCHITECTURE.md) · [Prompting](docs/PROMPTING.md)
...
A complete sample report lives in [`examples/interview__example.json`](examples/interview_Anatoliy_example.json).
