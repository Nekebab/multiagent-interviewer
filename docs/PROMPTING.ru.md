...
**Prompt-as-config.** Вынести промпты в YAML/JSON, если их нужно тюнить без редеплоя. Для этого проекта Jinja2-файлы в репо нормально — trade-off в пользу воспроизводимости против гибкости.
